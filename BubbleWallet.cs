...
namespace Palantir
{
    ...
    public static class BubbleWallet
    {
        ...
        public static List<MappedAwardGalleryInv> GetAwardGallery(int login)
        {
            ...
            return awards.ConvertAll(a => new MappedAwardGalleryInv() { inv= a.inv, award= a.award, image= tags.Find(t => t.ImageId == a.inv.ImageId) }).OrderBy(a => a.image?.Date ?? Int128.MaxValue).ToList();
        }
